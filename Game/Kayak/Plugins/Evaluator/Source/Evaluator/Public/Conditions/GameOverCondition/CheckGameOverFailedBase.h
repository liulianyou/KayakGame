...
class EVALUATOR_API UCheckGameOverFailedBase : public UCheckGameOverBase
{
...
class EVALUATOR_API UCheckGameOverFailed_ForwardCondition : public UCheckGameOverFailedBase
{
	GENERATED_UCLASS_BODY()
