...
void UCheckGameOver_Disconnect::NativeInitialize(UObject* OwnerObject)
{
	...
	{
		DelegateHandle = FEvaluatorNeededDelegate::DisconnectNativeEvent.AddUObject(this, &UCheckGameOver_Disconnect::DisconnectEventCallback);
	}
...
void UCheckGameOver_Disconnect::BeginDestroy()
{
	...
	{
		FEvaluatorNeededDelegate::DisconnectNativeEvent.Remove(DelegateHandle);
