...
public:
	...
	UEvaluatorOperation* GetPreFilterCondition() const {return  PreFilterCondition;}
	const TArray<URespawnPostProcessBase*>& GetPostProcess() const { return  PostProcess; }
	...
	FRespawnPointSingleInfo& GetPointInfo(URespawnDataBase* RuntimeData, ARespawnEditorDataBase* EditorData, int GroupIndex = INDEX_NONE, int PawIndex = INDEX_NONE);
...
private:
	...
	UPROPERTY(BlueprintReadOnly, EditAnywhere, Instanced, Category = "TriggerEditor|ARespawnEditorPoint", meta = (AllowPrivateAccess = "true"))
