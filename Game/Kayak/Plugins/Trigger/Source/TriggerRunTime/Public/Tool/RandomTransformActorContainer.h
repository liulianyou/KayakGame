...
#include "Tool/PlaceableActorContainer.h"
#include "RandomTransformActorContainer.generated.h"
 ...
 */
UCLASS()
class TRIGGERRUNTIME_API ARandomTransformActorContainer : public APlaceableActorContainer
{
