...
void UCheckGameOver_Exist::NativeInitialize(UObject* OwnerObject)
{
	...
	{
		DelegateHandle = FTriggerNeededDelegate::ExitCurrentMapNativeEvent.AddUObject(this, &UCheckGameOver_Exist::ExistCurrentMapEventCallback);
	}
}
...
void UCheckGameOver_Exist::BeginDestroy()
{
	...
	{
		FTriggerNeededDelegate::ExitCurrentMapNativeEvent.Remove(DelegateHandle);
