...
/**
 * custom tag widget, copy from SGameplayTagWidget, used to filter trigger tag by default.
 */
class SCustomTagWidget : public SCompoundWidget
{
public:
    ...
    SLATE_BEGIN_ARGS(SCustomTagWidget)
        : _Filter()
        , _NewTagName(TEXT(""))
        , _ReadOnly(false)
